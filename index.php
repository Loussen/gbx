...
$blogArr = [1 => 'xeberler', 2 => 'kampaniyalar', 3 => 'populyar-meqaleler', 4 => 'vakansiyalar'];
...
<div class="container"
     style="padding: 0 30px;background-color: #fff;border: 1px solid #eee;margin-top: 10px;border-radius: 20px 20px 0 0;border-bottom: none; <?= ($do == 'home') ? 'border-radius: 20px 20px 0 0;' : 'margin-bottom: 10px; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; border-bottom: 1px solid #eee;' ?>">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo">
                            ...
                            <a href="http://www.jointcommissioninternational.org/about-jci/jci-accredited-organizations/?c=Azerbaijan"
                               target="_blank">
                    ...
                    <div class="col-sm-8">
                        <div class="row pdtb">
                            <div class="col-sm-6" style="padding-top: 15px;padding-right: 25px;">
                                <div id="custom-search-input">
                                    <form action="<?= SITE_PATH ?>/axtarish" method="GET">
                                        <div class="input-group col-md-12">
                                            <input class="form-control" minlength="3" name="search"
                                                   placeholder="<?= $lang1 ?>..."
                            ...
                            <div class="col-sm-6" style="padding-left:0;padding-right:0;text-align:center;">
                                <a style="float: left;" href="tel: +99422203"><img
                                            src="<?= SITE_PATH ?>/assets/img/alo_1.svg"></a>
                                <a href="tel: <?= $info_contacts['mobile'] ?>" style="text-decoration: none;">
                                    <i style="color: #a67a5d; font-size: 35px;" class="fa fa-mobile"></i>
                                    <i style="color: #a67a5d; font-size: 35px;" class="fa fa-whatsapp"></i>
                                    <ul class="phone-main">
                                        <li style="color: #a67a5d; font-weight: bold;"><?= $info_contacts['mobile'] ?></li>
                                    </ul>
                                </a>
                            </div>
                        </div>
