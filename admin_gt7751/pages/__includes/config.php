...
if(!defined('db_name')) define('db_name','gbx');
$admin_folder='admin_gt7751';
$site="https://localhost/gbx_new";	// sonda / iwaresi qoyulmasin ve admin_folder burada qeyd edilmesin. ondan 1 vahid onceki foldere qeder qeyd edilsin.
