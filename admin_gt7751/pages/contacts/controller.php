...
{
	$datas_post=array('text','footer','email','facebook','twitter','google','youtube','instagram','mobile','skype','fax','phone','google_map','vkontakte','linkedin','digg','flickr','dribbble','vimeo','myspace');
