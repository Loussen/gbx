...
{
	$datas_post=array('text','footer','email','email2','facebook','twitter','google','youtube','instagram','mobile','skype','fax','phone','phone2','google_map','vkontakte','linkedin','digg','flickr','dribbble','vimeo','myspace','website');
	include "pages/__tools/check_post_datas.php";
	
	if($error==''){
		include "pages/__tools/create_only_langs_query.php";
		
		mysqli_query($db,"update $do set $query_update, email='$email',email2='$email2',facebook='$facebook',twitter='$twitter', vkontakte='$vkontakte',linkedin='$linkedin',digg='$digg',flickr='$flickr', dribbble='$dribbble', vimeo='$vimeo',myspace='$myspace',google='$google',  youtube='$youtube', instagram='$instagram', phone='$phone', phone2='$phone2', mobile='$mobile', skype='$skype', fax='$fax',google_map='$google_map',website='$website' ");
