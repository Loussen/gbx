        ...
        <div class="row">
            <div class="col-lg-9 col-md-9">
                <div class="page-title">
                    <h1><?=$info_service['name_'.$lang_name]?></h1>
                </div>
            </div>
                ...
                <div class="page-breadcumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb ">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?=$info_service['name_'.$lang_name]?></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-xl-7 col-lg-8">
                <div class="about-right-side">
                    <div class="about-title">
                        ...
                        <h2><?=$info_service['name_'.$lang_name]?></h2>
                    </div>
                    <div class="about-text content-text">
                        <p><?=decode_text($info_service['full_text_'.$lang_name],true)?></p>
                    </div>
                </div>
            </div>
        </div>
