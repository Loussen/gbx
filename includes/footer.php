        ...
        <li class="lang-mob">
            <ul class="list-unstyled pull-left">
                <li class="dropdown lng">
                    ...
                    ?>
                    <a aria-expanded="false" style="color: #a67a5d;" class="btn-lang dropdown-toggle"
                       data-toggle="dropdown" href="#" role="button"><img
                                src="<?= SITE_PATH ?>/assets/img/flags/<?= $row_selected_lang['name'] ?>.png"><?= $row_selected_lang['full_name'] ?>
                    ...
                    <ul class="dropdown-menu lang lang-drop" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                        ...
                        while ($row_langs = mysqli_fetch_assoc($sql_langs)) {
                            ?>
                            <li>
                                <a href="<?= SITE_PATH ?>/index.php?change_lang_name=<?= $row_langs['name'] ?>"><img
                                            src="<?= SITE_PATH ?>/assets/img/flags/<?= $row_langs['name'] ?>.png"><?= $row_langs['full_name'] ?>
                                </a>
                            </li>
                            <?php
                        }
            ...
            <ul class="social-top pull-right mobile-social-top">
                <li>
            ...
            <div id="custom-search-input-mob">
                <form action="<?= SITE_PATH ?>/axtarish" method="GET">
                    <div class="input-group col-md-12">
                        ...
                        <input minlength="3" class="form-control" placeholder="<?= $lang1 ?>...
" name="search" type="text"> <span class="input-group-btn"><button class="btn btn-info btn-lg" type="button"><span
...
<div class="navbar navbar-default navbar-fixed-top hidden-md hidden-lg">
    <button class="navbar-toggle" data-target=".navmenu" data-toggle="offcanvas" type="button"><span
                class="icon-bar"></span><span class="icon-bar"></span> <span class="icon-bar"></span></button>
    <a class="pull-left" style="margin-left: 6%;" href="<?= SITE_PATH ?>"><img src="<?= SITE_PATH ?>/assets/img/logos/logo-web.svg"></a>
</div>
<a class="btn btn-primary btn-lg back-to-top hidden-xs" data-placement="left" data-toggle="tooltip" href="#"
   id="back-to-top" role="button" title="Səhifənin başına get"><i aria-hidden="true" class="fa fa-chevron-up"></i></a>