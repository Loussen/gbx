            ...
            <div class="col-md-1">
                <ul class="list-unstyled social">
                    <li class="dropdown lng">
                        <a aria-expanded="false" class="btn-lang dropdown-toggle" data-toggle="dropdown" href="#" role="button"><img src="<?=SITE_PATH?>/assets/img/flags/az.png">Az <i aria-hidden="true" class="fa fa-angle-down hidden-md"></i></a>
                        <ul class="dropdown-menu lang lang-drop" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                            <li>
                                <a href=""><img src="<?=SITE_PATH?>/assets/img/flags/ru.png">Ру</a>
                            </li>
                            <li>
                                <a href=""><img src="<?=SITE_PATH?>/assets/img/flags/en.png">En</a>
                            </li>
                        </ul>
                    </li>
                </ul>
